...
{
    class GetInverseTests : public ::testing::TestWithParam<std::tuple<NativeCore::Matrix, NativeCore::Matrix>>
    {
    };

    INSTANTIATE_TEST_SUITE_P(GetInverseTestsSuite, GetInverseTests,
                             ::testing::Values(std::make_tuple( // 2X2 matrix for GetInverse test
