...
{
    class GetReducedEchelonFormTests
        : public ::testing::TestWithParam<std::tuple<NativeCore::Matrix, NativeCore::Matrix>>
    {
    };

    INSTANTIATE_TEST_SUITE_P(
        GetReducedEchelonFormTestsSuite, GetReducedEchelonFormTests,
        ::testing::Values(std::make_tuple(NativeCore::Matrix(3, 3, {1, 2, 3, 2, 3, 3, 2, 4, 3}),   // original
