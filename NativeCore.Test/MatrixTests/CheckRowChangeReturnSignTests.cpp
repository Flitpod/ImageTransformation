...
{
    class CheckRowChangeReturnSignTests
        : public ::testing::TestWithParam<std::tuple<NativeCore::Matrix, NativeCore::Matrix, int, int, int>>
    {
    };

    INSTANTIATE_TEST_SUITE_P(CheckRowChangeReturnSignTestsSuite, CheckRowChangeReturnSignTests,
                             ::testing::Values(std::make_tuple( // transpose of 3x3 matrix
