...
{
    class TransposeTests : public ::testing::TestWithParam<std::tuple<NativeCore::Matrix, NativeCore::Matrix>>
    {
    };

    INSTANTIATE_TEST_SUITE_P(TransposeTestsSuite, TransposeTests,
                             ::testing::Values(std::make_tuple( // transpose of 3x2 matrix
